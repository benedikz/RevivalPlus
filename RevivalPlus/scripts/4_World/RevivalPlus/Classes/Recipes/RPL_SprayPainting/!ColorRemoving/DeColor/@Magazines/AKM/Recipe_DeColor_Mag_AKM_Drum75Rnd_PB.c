class DeColor_Mag_AKM_Drum75Rnd_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Mag_AKM_Drum75Rnd_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Mag_AKM_Drum75Rnd", player, specialty_weight);
  }
};
