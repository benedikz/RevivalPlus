class PreserveZucchinis extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_ZucchiniStack");
    ...
    /*************************************************************/
    AddResult("RPL_ImprovisedCan_Zucchinis");
    /*************************************************************/
  ...
  {
    //Trace.Log(0, "<PreserveZucchinis> Called.");
  }
};
