class PaintMosin9130_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "Mosin9130", player, specialty_weight);
    //Trace.Log(0, "<PaintMosin9130_DarkTan> Called.");
  }
};
