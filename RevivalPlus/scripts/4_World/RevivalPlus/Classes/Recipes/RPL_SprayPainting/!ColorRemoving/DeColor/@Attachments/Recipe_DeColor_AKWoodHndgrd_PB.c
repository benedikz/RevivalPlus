class DeColor_AKWoodHndgrd_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_AK_WoodHndgrd_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "AK_WoodHndgrd", player, specialty_weight);
    //Trace.Log(0, "<DeColor_AKWoodHndgrd_PB> Called.");
  }
};
