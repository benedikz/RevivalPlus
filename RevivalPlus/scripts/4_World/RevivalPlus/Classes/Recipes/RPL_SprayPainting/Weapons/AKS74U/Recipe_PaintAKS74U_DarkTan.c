class PaintAKS74U_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "AKS74U", player, specialty_weight);
    //Trace.Log(0, "<PaintAKS74U_DarkTan> Called.");
  }
};
