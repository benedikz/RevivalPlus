class PaintPowerGenerator_Black extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "PowerGenerator");
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "PowerGenerator", player, specialty_weight);
    //Trace.Log(0, "<PaintPowerGenerator_Black> Called.");
  }
};
