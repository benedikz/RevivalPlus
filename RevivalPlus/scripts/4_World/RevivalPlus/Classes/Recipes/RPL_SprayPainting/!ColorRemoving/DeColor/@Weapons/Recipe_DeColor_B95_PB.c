class DeColor_B95_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_B95_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "B95", player, specialty_weight);
    //Trace.Log(0, "<DeColor_B95_PB> Called.");
  }
};
