class DeColor_Mosin9130_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Mosin9130_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Mosin9130", player, specialty_weight);
    //Trace.Log(0, "<DeColor_Mosin9130_PB> Called.");
  }
};
