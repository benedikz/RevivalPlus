class StackApples extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    m_Name = "#STR_RPL_Recipe_Stack";
  ...
  {
    //Trace.Log(0, "<StackApples> Called.");
  }
};
