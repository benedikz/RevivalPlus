class PaintFAL_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "FAL", player, specialty_weight);
    //Trace.Log(0, "<PaintFAL_DarkTan> Called.");
  }
};
