class CraftImprovisedAlcoholBottle extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    m_Name = "#STR_RPL_Recipe_CraftImprovisedBottleAlcohol";
    ...
    /*************************************************************/
    InsertIngredient(0, "RPL_EmptyBottleAlcohol");
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_PaperStrip");
    ...
    /*************************************************************/
    AddResult("RPL_ImprovisedBottleAlcohol");
    /*************************************************************/
  ...
  {
    //Trace.Log(0, "<CraftImprovisedCan> Called.");
  }
};
