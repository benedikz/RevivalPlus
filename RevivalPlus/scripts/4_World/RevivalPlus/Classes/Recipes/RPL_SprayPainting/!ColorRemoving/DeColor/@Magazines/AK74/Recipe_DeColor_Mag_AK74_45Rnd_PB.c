class DeColor_Mag_AK74_45Rnd_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Mag_AK74_45Rnd_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Mag_AK74_45Rnd", player, specialty_weight);
  }
};
