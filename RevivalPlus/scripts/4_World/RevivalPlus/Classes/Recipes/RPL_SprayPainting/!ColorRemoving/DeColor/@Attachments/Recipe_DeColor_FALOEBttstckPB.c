class DeColor_FalOeBttstck_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Fal_OeBttstck_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Fal_OeBttstck", player, specialty_weight);
    //Trace.Log(0, "<DeColor_FalOeBttstck_PB> Called.");
  }
};
