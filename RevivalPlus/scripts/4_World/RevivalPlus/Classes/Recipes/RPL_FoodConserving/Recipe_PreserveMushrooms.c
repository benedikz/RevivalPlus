class PreserveMushrooms extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    m_MinQuantityIngredient[1] = 8;
    m_MaxQuantityIngredient[1] = 8;
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_MushroomStack");
    ...
    /*************************************************************/
    AddResult("RPL_ImprovisedCan_Mushrooms");
    /*************************************************************/
  ...
  {
    //Trace.Log(0, "<PreserveMushrooms> Called.");
  }
};
