class DeColor_SVD_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_SVD_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "SVD", player, specialty_weight);
    //Trace.Log(0, "<DeColor_SVD_PB> Called.");
  }
};
