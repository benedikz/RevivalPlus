class PreserveSardines extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    m_MinQuantityIngredient[1] = 6;
    m_MaxQuantityIngredient[1] = 6;
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_SardineStack");
    ...
    /*************************************************************/
    AddResult("RPL_ImprovisedCan_Sardines");
    /*************************************************************/
  ...
  {
    //Trace.Log(0, "<PreserveSardines> Called.");
  }
};
