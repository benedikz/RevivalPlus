class DeColor_AK74WoodHndgrd_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_AK74_WoodHndgrd_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "AK74_WoodHndgrd", player, specialty_weight);
    //Trace.Log(0, "<DeColor_AK74WoodHndgrd_PB> Called.");
  }
};
