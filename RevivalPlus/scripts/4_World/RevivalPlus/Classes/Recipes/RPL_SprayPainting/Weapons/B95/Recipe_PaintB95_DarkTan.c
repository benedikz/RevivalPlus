class PaintB95_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "B95", player, specialty_weight);
    //Trace.Log(0, "<PaintB95_DarkTan> Called.");
  }
};
