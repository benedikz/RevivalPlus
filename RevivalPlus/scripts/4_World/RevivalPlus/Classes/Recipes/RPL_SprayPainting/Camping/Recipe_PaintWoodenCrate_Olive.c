class PaintWoodenCrate_Olive extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "WoodenCrate");
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "WoodenCrate", player, specialty_weight);
    //Trace.Log(0, "<PaintWoodenCrate_Olive> Called.");
  }
};
