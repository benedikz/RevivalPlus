class DeColor_Winchester70_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Winchester70_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Winchester70", player, specialty_weight);
    //Trace.Log(0, "<DeColor_Winchester70_PB> Called.");
  }
};
