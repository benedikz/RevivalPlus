class DeColor_Glock19_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Glock19_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Glock19", player, specialty_weight);
    //Trace.Log(0, "<DeColor_Glock19_PB> Called.");
  }
};
