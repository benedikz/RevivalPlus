class PaintMag_FAL_20Rnd_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "Mag_FAL_20Rnd");
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "Mag_FAL_20Rnd", player, specialty_weight);
  }
};
