class DeColor_MotoHelmet_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_MotoHelmet_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "MotoHelmet", player, specialty_weight);
    //Trace.Log(0, "<DeColor_MotoHelmet_PB> Called.");
  }
};
