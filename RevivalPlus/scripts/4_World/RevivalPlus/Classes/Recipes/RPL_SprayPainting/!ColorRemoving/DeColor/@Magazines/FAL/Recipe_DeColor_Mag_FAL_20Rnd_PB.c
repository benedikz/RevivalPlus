class DeColor_Mag_FAL_20Rnd_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Mag_FAL_20Rnd_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Mag_FAL_20Rnd", player, specialty_weight);
  }
};
