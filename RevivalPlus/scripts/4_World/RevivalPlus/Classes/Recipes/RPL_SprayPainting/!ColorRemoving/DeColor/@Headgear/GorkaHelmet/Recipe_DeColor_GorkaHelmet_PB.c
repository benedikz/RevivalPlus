class DeColor_GorkaHelmet_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_GorkaHelmet_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "GorkaHelmet", player, specialty_weight);
    //Trace.Log(0, "<DeColor_GorkaHelmet_PB> Called.");
  }
};
