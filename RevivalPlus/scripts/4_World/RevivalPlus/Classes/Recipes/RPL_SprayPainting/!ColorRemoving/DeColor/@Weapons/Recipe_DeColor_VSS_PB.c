class DeColor_VSS_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_VSS_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "VSS", player, specialty_weight);
    //Trace.Log(0, "<DeColor_VSS_PB> Called.");
  }
};
