class PaintSVD_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "SVD", player, specialty_weight);
    //Trace.Log(0, "<PaintSVD_DarkTan> Called.");
  }
};
