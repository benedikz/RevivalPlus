class DeColor_Repeater_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Repeater_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Repeater", player, specialty_weight);
    //Trace.Log(0, "<DeColor_Repeater_PB> Called.");
  }
};
