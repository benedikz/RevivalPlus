class DeColor_Ruger1022_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Ruger1022_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Ruger1022", player, specialty_weight);
    //Trace.Log(0, "<DeColor_Ruger1022_PB> Called.");
  }
};
