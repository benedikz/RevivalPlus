class PaintSKS_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "SKS", player, specialty_weight);
    //Trace.Log(0, "<PaintSKS_DarkTan> Called.");
  }
};
