class DeColor_Mag_STANAG_30Rnd_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_Mag_STANAG_30Rnd_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "Mag_STANAG_30Rnd", player, specialty_weight);
  }
};
