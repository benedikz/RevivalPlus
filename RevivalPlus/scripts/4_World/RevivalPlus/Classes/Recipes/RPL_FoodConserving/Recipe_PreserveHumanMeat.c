class PreserveHumanMeat extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_HumanMeatStack");
    ...
    /*************************************************************/
    AddResult("RPL_ImprovisedCan_HumanMeat");
    /*************************************************************/
  ...
  {
    //Trace.Log(0, "<PreserveHumanMeat> Called.");
  }
};
