class PaintVSS_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "VSS", player, specialty_weight);
    //Trace.Log(0, "<PaintVSS_DarkTan> Called.");
  }
};
