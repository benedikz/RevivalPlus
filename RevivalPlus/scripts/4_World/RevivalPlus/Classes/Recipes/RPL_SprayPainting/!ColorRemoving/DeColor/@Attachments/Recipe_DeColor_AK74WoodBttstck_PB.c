class DeColor_AK74WoodBttstck_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_AK74_WoodBttstck_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "AK74_WoodBttstck", player, specialty_weight);
    //Trace.Log(0, "<DeColor_AK74WoodBttstck_PB> Called.");
  }
};
