class DeColor_AKS74U_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_AKS74U_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "AKS74U", player, specialty_weight);
    //Trace.Log(0, "<DeColor_AKS74U_PB> Called.");
  }
};
