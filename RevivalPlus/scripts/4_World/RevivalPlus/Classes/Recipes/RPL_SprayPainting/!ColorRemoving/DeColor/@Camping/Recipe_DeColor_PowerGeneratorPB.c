class DeColor_PowerGenerator_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_PowerGenerator_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "PowerGenerator", player, specialty_weight);
    //Trace.Log(0, "<DeColor_PowerGenerator_PB> Called.");
  }
};
