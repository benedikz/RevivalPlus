class DeColor_SKS_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_SKS_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "SKS", player, specialty_weight);
    //Trace.Log(0, "<DeColor_SKS_PB> Called.");
  }
};
