class PaintGlock19_DarkTan extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
  ...
  {
    RPL_PaintItem.Paint(ingredients[0], ingredients[1], "Glock19", player, specialty_weight);
    //Trace.Log(0, "<PaintGlock19_DarkTan> Called.");
  }
};
