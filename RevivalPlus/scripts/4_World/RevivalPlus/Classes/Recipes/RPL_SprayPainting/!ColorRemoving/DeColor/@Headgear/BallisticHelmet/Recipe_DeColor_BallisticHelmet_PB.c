class DeColor_BallisticHelmet_PB extends RecipeBase
{
  override void Init()
	{
    /*************************************************************/
    ...
    /*************************************************************/
    InsertIngredient(1, "RPL_BallisticHelmet_PaintBase");
  ...
  {
    RPL_PaintItem.RemovePaint(ingredients[1], "BallisticHelmet", player, specialty_weight);
    //Trace.Log(0, "<DeColor_BallisticHelmet_PB> Called.");
  }
};
